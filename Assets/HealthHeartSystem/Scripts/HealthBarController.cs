...
public class HealthBarController : MonoBehaviour
{
    ...
    void Update(){
        GameObject hbar = GameObject.FindGameObjectWithTag("healthBar");
        if(hbar != null && hbar.GetComponent<reInstantiationHeart>().heartInstantiated == false){
            hbar.GetComponent<reInstantiationHeart>().heartInstantiated = true;
            heartsParent = hbar.GetComponent<Transform>();  
